...
| [EP-006](EP-006-tres-stacks-num-dia.md) | Três stacks num dia, e a pergunta que estava errada | 2026-07-27 | Claude Opus 5 + WAR ROOM (4 agentes) + 5 MCPs | **Sim** — enquadramento errado, tamanho citado de memória, probe com POST quebrado reportada como validação |
